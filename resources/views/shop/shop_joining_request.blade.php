    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                ...
                <!--    </ol>-->
                <!--</div>-->
                <h4 class="page-title">View All Joining Requests</h4>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-3">
            <div class="card client-card">
                <div class="card-body text-center">
                    ...
                    <a href="{{ url('/accept_joinning_request/'.$data->id) }}" class="btn btn-sm btn-gradient-success">Accept</a>
                    <a href="{{ url('/reject_joinning_request/'.$data->id) }}" class="btn btn-sm btn-gradient-danger">Reject</a>
                </div>
            </div>
        </div>
        @endforeach
