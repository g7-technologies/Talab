    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="page-title-box">
                ...
                <!--    </ol>-->
                <!--</div>-->
                <h4 class="page-title">View All Deactive Products</h4>
            </div>
        </div>
    </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="{{ url('/admin_activate_product/'.$product->id) }}"><i class="fas fa-check text-success" alt="activate"></i></a>
                                ...
                                <div class="col-md-3"> 
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <a href="{{ url('/activate_product/'.$product->id) }}" class="btn btn-soft-success btn-block">Activate</a>
                                        </div>
                                    </div>
                                </div>
                                @endif
